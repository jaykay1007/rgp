...
export default function Testimonials() {
  ...
  return (
    <section className="relative isolate overflow-hidden bg-gradient-to-b from-[#01040c] via-[#050b16] to-[#0f1729] py-28 text-white">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,_rgba(255,255,255,0.1),_transparent_60%)]" />
      <div className="absolute right-10 top-10 h-64 w-64 rounded-full bg-secondary/10 blur-[140px]" />
      ...
      <div className="container relative z-10">
        ...
        >
          <SectionHeading
            ...
            title={<h2 className="font-display text-4xl md:text-5xl leading-tight">Whispered praise from couture houses & textile labs.</h2>}
            description="Wedding directors, export CEOs, and event architects trust our atelier for concierge communication, obsessive QA, and deliveries that land calm."
          />
        </motion.div>
